...
def main():
    ...
    tv = st.number_input("Investment on 📺(Tv) advertisements [1000$]",min_value=0, step=1)
    radio = st.number_input("Investment on 📻(Radio) advertisements [1000$]",min_value=0, step=1)
